...
nbr_random = 3000000 # Should be more than a million in real situation
...
output_T_3 = MaxPooling1D(pool_size=6, padding='same')(output_T_2)
#output_T_3 = BatchNormalization()(output_T_3)
output_T_4 = Conv1D(filters=60, kernel_size = 10, activation='relu',padding='same')(output_T_3)
output_T_5 = MaxPooling1D(pool_size= 5, padding='same')(output_T_4)
#output_T_5 = BatchNormalization()(output_T_5)
output_T_6 = Conv1D(filters=60, kernel_size = 10, activation='relu',padding='same')(output_T_5)

Encoded = MaxPooling1D(pool_size=4, padding='same')(output_T_6)
Encoded = BatchNormalization()(Encoded)


decoded3 = Conv1D(filters=60, kernel_size = 10, activation='relu',padding='same')(Encoded)
decoded4 = UpSampling1D(size=4)(decoded3)
...
decoded8 = UpSampling1D(size=6)(decoded7)
#decoded8 = BatchNormalization()(decoded8)

decoded = Conv1D(filters=1, kernel_size=16, activation = 'tanh', padding='same')(decoded8)
...
callbacks = [
	...
	ModelCheckpoint('weights/weight_autoenc_advanced120.hdf5', monitor='val_loss', verbose=0, save_best_only='true', save_weights_only='true', mode='auto', period=1)
]
...
Autoencodeur.save('models/Auto_encoder_advanced120.h5')
